...
#define EFF_TEXT                (59U)    // Бегущая строка


#define MODE_AMOUNT           (60U)          // количество режимов
...
String("27. Разноцветные вихри,100,255,1,100,0;") +
...
String("36. Комета,60,255,1,100,0;") +
...
String("59. Бегущая строка,1,255,1,100,1;") +
...
String("27. Color whirls,100,255,1,100,0;") +
...
String("36. Comet,60,255,1,100,0;") +
...
String("44. Rainbow kite,60,255,100,100,0;") +
...
String("59. Ticker,1,255,1,100,1;") +
// ЭФФЕКТ БЕГУЩАЯ СТРОКА ДОЛЖЕН БЫТЬ ПОСЛЕДНИМ ВСЕГДА!!!
String(+ "\n");
