...
#endif
#define LED_PIN               (5U)                          // пин ленты                (D4)->D1
#define BTN_PIN               (4U)                          // пин кнопки               (D2)
#define MOSFET_PIN            (2U)                          // пин MOSFET транзистора   (D1)->D4 - может быть использован для управления питанием матрицы/ленты
...
#define AP_NAME               ("FireLamp")                  // имя WiFi точки доступа, используется как при запросе SSID и пароля WiFi сети роутера, так и при работе в режиме ESP_MODE = 0
...
#define NTP_INTERVAL          (30UL * 60UL * 1000UL)        // интервал синхронизации времени (было 30 минут)
...
#define LOCAL_OFFSET          (1 * 60)                      // смещение локального времени относительно универсального координированного времени UTC в минутах
#define LOCAL_TIMEZONE_NAME   ("MEZ")                       // обозначение локального часового пояса; до 5 символов; может быть использовано, если понадобится его вывести после вывода времени
#else
...
#define SUMMER_HOUR           (2U)                          // час (по зимнему времени!), когда заканчивается зимнее время и начинается летнее; [0..23]
#define SUMMER_OFFSET         (2 * 60)                      // смещение летнего времени относительно универсального координированного времени UTC в минутах
#define SUMMER_TIMEZONE_NAME  ("MESZ")                      // обозначение летнего времени; до 5 символов; может быть использовано, если понадобится его вывести после вывода времени; может быть "ЛЕТ"
...
#define WINTER_TIMEZONE_NAME  ("MEZ")                       // обозначение зимнего времени; до 5 символов; может быть использовано, если понадобится его вывести после вывода времени; может быть "ЗИМ"
#endif
...
#define MODE_AMOUNT           (63U)          // количество режимов
...
/*
  ...
  String("20. Матрица,100,240,1,100,0;") +
  String("21. Огонь 2018,50,255,100,100,0;") +
  String("22. Огонь,50,255,1,100,1;") +
  String("23. Белый огонь,50,255,1,100,1;") +
  String("24. Голубой огонь,50,255,1,100,1;") +
  String("25. Зелёный огонь,50,255,1,100,1;") +
  String("26. Вихри пламени,100,255,1,100,1;") +
  String("27. Разноцветные вихри,100,255,1,100,1;") +
  String("28. Водопад,50,255,1,100,1;") +
  String("29. Белый водопад,50,255,1,100,1;") +
  String("30. Водопад 4 в 1,50,255,1,100,0;") +
  String("31. Бассейн,100,255,1,100,1;") +
  String("32. Медленный пульс,50,255,1,100,0;") +
  String("33. Быстрый пульс,50,255,1,100,0;") +
  String("34. Радужный пульс,50,255,1,100,0;") +
  String("35. Белый пульс,50,255,1,100,0;") +
  String("36. Комета,60,255,1,100,2;") +
  String("37. Белая комета,60,255,1,100,0;") +
  String("38. Одноцветная комета,60,255,1,100,1;") +
  String("39. Пульсирующая комета,60,255,1,100,0;") +
  String("40. Две кометы,60,255,1,100,0;") +
  String("41. Три кометы,60,255,1,100,0;") +
  String(+ "\n");
  const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
  String("42. Парящий огонь,60,255,1,100,0;") +
  String("43. Верховой огонь,60,255,1,100,0;") +
  String("44. Радужный змей,60,255,100,100,0;") +
  String("45. Конфетти,60,255,1,100,0;") +
  String("46. Радуга вертикальная,50,255,1,100,0;") +
  String("47. Радуга горизонтальная,50,255,1,100,0;") +
  String("48. Радуга диагональная,50,255,1,100,0;") +
  String("49. Волны,220,255,1,100,0;") +
  String("50. Снегопад,50,255,1,100,0;") +
  String("51. Цветной дождь,60,255,1,100,1;") +
  String("52. Метель,50,255,1,100,0;") +
  String("53. Звездопад,50,255,1,100,0;") +
  String("54. Светлячки,50,240,1,100,0;") +
  String("55. Светлячки со шлейфом,50,240,1,100,0;") +
  String("56. Пейнтбол,215,255,1,100,0;") +
  String("57. Блуждающий кубик,70,235,1,100,0;") +
  String("58. Смена цвета,1,255,1,100,0;") +
  String("59. Тучка в банке,100,1,1,100,0;") +                // EFF_SIMPLE_RAIN
  String("60. Гроза в банке,255,1,1,100,0;") +                // EFF_STORMY_RAIN
  String("61. Мерцание,255,1,1,100,0;") +                     // EFF_TWINKLES
  String("62. Бегущая строка,1,255,1,100,1;") +
...
const String efList_1 = String("LIST1;") + // ======== ПЕРВАЯ СТРОКА ========
                        ...
                        String("2. Madness,1,150,1,100,0;") +
                        String("3. Clouds,1,15,1,50,0;") +
                        String("4. Lava,5,60,1,100,0;") +
                        String("5. Plasma,1,30,1,100,0;") +
                        String("6. Rainbow 3D,1,70,1,100,0;") +
                        String("7. Peacock,1,15,1,30,0;") +
                        String("8. Zebra,1,30,7,40,0;") +
                        String("9. Forest,2,30,70,100,0;") +
                        String("10. Ocean,2,15,4,30,0;") +
                        String("11. Bouncing balls,1,255,1,100,0;") +
                        String("12. White bouncing balls,1,255,1,100,0;") +
                        String("13. Balls with a train,1,255,1,100,0;") +
                        String("14. Spirals,1,255,1,100,0;") +
                        String("15. Prismata,1,255,1,100,0;") +
                        String("16. Flock,1,255,1,100,0;") +
                        String("17. Flock and predator,1,255,1,100,0;") +
                        String("18. Sinusoid,1,255,1,100,0;") +
                        String("19. Metaballs,1,255,1,100,0;") +
                        String(+ "\n");
const String efList_2 = String("LIST2;") + // ======== ВТОРАЯ СТРОКА ========
                        String("20. Matrix,100,240,1,100,0;") +
                        String("21. Fire 2018,50,255,100,100,0;") +
                        String("22. Fire,50,255,1,100,1;") +
                        String("23. White Fire,50,255,1,100,1;") +
                        String("24. Blue Fire,50,255,1,100,1;") +
                        String("25. Green Fire,50,255,1,100,1;") +
                        String("26. Whirls of flame,100,255,1,100,1;") +
                        String("27. Color whirls,100,255,1,100,1;") +
                        String("28. Waterfall,50,255,1,100,1;") +
                        String("29. White waterfall,50,255,1,100,1;") +
                        String("30. Waterfall 4 in 1,50,255,1,100,0;") +
                        String("31. Pool,100,255,1,100,1;") +
                        String("32. Slow pulse,50,255,1,100,0;") +
                        String("33. Fast pulse,50,255,1,100,0;") +
                        String("34. Rainbow pulse,50,255,1,100,0;") +
                        String("35. White pulse,50,255,1,100,0;") +
                        String("36. Comet,60,255,1,100,2;") +
                        String("37. White comet,60,255,1,100,0;") +
                        String("38. Plain Comet,60,255,1,100,1;") +
                        String("39. Pulsating comet,60,255,1,100,0;") +
                        String("40. Two comets,60,255,1,100,0;") +
                        String("41. Three comets,60,255,1,100,0;") +
                        String(+ "\n");
const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
                        String("42. Soaring fire,60,255,1,100,0;") +
                        String("43. Top fire,60,255,1,100,0;") +
                        String("44. Rainbow snake,60,255,100,100,0;") +
                        String("45. Confetti,60,255,1,100,0;") +
                        String("46. Rainbow vertical,50,255,1,100,0;") +
                        String("47. Rainbow horizontal,50,255,1,100,0;") +
                        String("48. Rainbow diagonal,50,255,1,100,0;") +
                        String("49. Waves,220,255,1,100,0;") +
                        String("50. Snowfall,50,255,1,100,0;") +
                        String("51. Colored rain,60,255,1,100,1;") +
                        String("52. Snowstorm,50,255,1,100,0;") +
                        String("53. Starfall,50,255,1,100,0;") +
                        String("54. Fireflies,50,240,1,100,0;") +
                        String("55. Fireflies with a train,50,240,1,100,0;") +
                        String("56. Paintball,215,255,1,100,0;") +
                        String("57. Wandering Cube,70,235,1,100,0;") +
                        String("58. Change of color,1,255,1,100,0;") +
                        String("59. Cloud in the jar,100,1,1,100,0;") +           // EFF_SIMPLE_RAIN
                        String("60. Thunder in the jar,255,1,1,100,0;") +         // EFF_STORMY_RAIN
                        String("61. Twinkles,255,1,1,100,0;") +                   // EFF_TWINKLES
                        String("62. Ticker,1,255,1,100,1;") +
                        // ЭФФЕКТ БЕГУЩАЯ СТРОКА ДОЛЖЕН БЫТЬ ПОСЛЕДНИМ ВСЕГДА!!!
                        String(+ "\n");
...
static const uint8_t defaultSettings[][3] PROGMEM = {
  ...
  {  15, 225,  63}, // Тучка в банке
  {  15, 225,  63}, // Гроза в банке
  {  16, 142,  63}, // Мерцание
